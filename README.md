...
## • Step 8 - Create Header and Avatar
...
## • Step 12 - Add the Sidebar Notification
...
## • Step 14 - Create Dynamic routes for ChatBox using Next.js features

1. Create a new [Dynamic Route](https://nextjs.org/docs/routing/dynamic-routes) inside Pages folder for the individuals chat.

- Create the file `./pages/chat/[id.js]`:
...
2. Edit the file `./components/Chat.jsx`to call the Dynamic Route created:
...
## • Step 15 - Add the ChatBox Header

1. Create the file `./components/ChatContent.jsx`:
...
2. Edit the file `./pages/chats/[id].js`:
...
## • Step 16 - Input for Sending Messages on ChatBox
...
## • Step 18 - Some CSS fixed

1. Edit the file `./components/Layout.jsx`:
...
2. Edit the file `./pages/chat/[id].js`:
